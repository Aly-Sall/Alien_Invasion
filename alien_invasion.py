...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        self.bullets.update()
        # Get rid of bullets that have traveled off the screen.
    ...
    def _update_screen(self):
        """Update images on the screen, and flip the screen to the new screen"""
        ...
        # Make the most recently drawn scree visible.
        pygame.display.flip()
